...
public class Boton extends Button {
    ...
    private void configurarEstilos() {
        ...
        setOnMousePressed(e -> setStyle("-fx-background-color: #808080; -fx-background-radius: 0px; -fx-font-size: 16px;"));
        setOnMouseReleased(e -> setStyle("-fx-background-color: #E9E9E9; -fx-background-radius: 0px; -fx-font-size: 16px;"));
    }
